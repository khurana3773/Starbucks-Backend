...
public class OrderResource extends ServerResource {
    ...
    public Representation get_action() throws JSONException {
        ...
        if ( headers != null ) {
            ...
            System.out.println("origin"+headers.getFirstValue("Origin"));
        }


        Map<String,Object> respObj = getResponse().getAttributes();
        Series<Header> headersResp = new Series(Header.class); // learn
        ...
        getResponse().setAccessControlAllowHeaders(origins);
        ...
        if ( order_id == null || order_id.equals("") ) {
            ...
            if ( order_id == null || order_id.equals("")  || existing_order == null ) {
                ...
                try { 
                    ...
                    getResponse().getHeaders().set("Access-Control-Allow-Origin","*");
